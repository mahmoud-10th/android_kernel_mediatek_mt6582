    ...
    *outEvent = NULL;
    ...
    while (!*outEvent) {
        ...
        case AINPUT_EVENT_TYPE_MOTION: {
            ...
            if ((mMsg.body.motion.action == AMOTION_EVENT_ACTION_MOVE || mMsg.body.motion.action == AMOTION_EVENT_ACTION_AREA_MOVE)
			#else
...
void InputConsumer::updateTouchState(InputMessage* msg) {
	...
	case AMOTION_EVENT_ACTION_AREA_DOWN:
	#endif
	...
	#if defined(LENOVO_AREA_TOUCH)//lenovo jixu add
	case AMOTION_EVENT_ACTION_AREA_MOVE:
	#endif
	...
	#if defined(LENOVO_AREA_TOUCH)//lenovo jixu add
	case AMOTION_EVENT_ACTION_AREA_UP:
	#endif
...
void InputConsumer::resampleTouchState(nsecs_t sampleTime, MotionEvent* event,
    ...
    if (!mResampleTouch
            ...
            #if defined(LENOVO_AREA_TOUCH)//lenovo jixu modify
            || event->getAction() != AMOTION_EVENT_ACTION_AREA_MOVE
            #endif
			) {
        return;
    }
